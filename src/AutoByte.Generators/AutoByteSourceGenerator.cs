    ...
    public class AutoByteSourceGenerator : ISourceGenerator
    {
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            {               
                ...
                var source = GenerateDeserializeImplementation(namespaceName, className);
        ...
        {
            // If we don't have a namespace at all we'll return null
        ...
        private class SyntaxReceiver : ISyntaxReceiver
        {
            ...
            {              
                if (syntaxNode is ClassDeclarationSyntax classDeclaration)
                {
                    ...
                    if (autoByteStructureAttribute != null && IsPartial(classDeclaration))
                    {
