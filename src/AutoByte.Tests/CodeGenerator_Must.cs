...
namespace AutoByte.Tests
{
    ...
    public class CodeGenerator_Must
    {
        ...
        public void GenerateCode_DeserializeZipFileHeader()
        {
            ...
            const string EXPECTED_FILENAME = "AutoByte.sln";

            Assert.Equal(EXPECTED_FILENAME, zip.FileName);
        }
        ...
        public void GenerateCode_DeserializeMasterBootRecord()
        {
            var sector = new byte[] {
                ...
                0x00, 0x20, 0xFB, 0xA0, 0x64, 0x7C, 0x3C, 0xFF, 0x74, 0x02, 0x88, 0xC2, 0x52, 0xBE, 0x80, 0x7D,
                0xE8, 0x17, 0x01, 0xBE, 0x05, 0x7C, 0xB4, 0x41, 0xBB, 0xAA, 0x55, 0xCD, 0x13, 0x5A, 0x52, 0x72,
                ...
                0xCD, 0x13, 0x73, 0x0D, 0x5A, 0x84, 0xD2, 0x0F, 0x83, 0xD8, 0x00, 0xBE, 0x8B, 0x7D, 0xE9, 0x82,
                ...
                ,
